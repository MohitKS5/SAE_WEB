jQuery(document).ready(function($){
	...
	function animateSection () {
		...
		$('.cd-section').each(function(){
			var facf = $(this).attr("data-aspect");
			var actualBlock = $(this),
				offset = scrollTop - actualBlock.offset().top,
				scale = 1,
				translate = windowWidth/2+'px',
				translate1 = windowWidth*facf+'px',
				translate2 = windowWidth*(1-facf)+'px',
				opacity,
				boxShadowOpacity;
			...
			if( offset >= -windowHeight && offset <= 0 ) {
				...
				translate1 = (windowWidth * facf * (- offset/windowHeight)).toFixed(0)+'px',
				translate2 = (windowWidth * (1-facf) * (- offset/windowHeight)).toFixed(0)+'px';
			...
			if(actualBlock.find('.cd-half-block')) {
				translateBlock(actualBlock.find('.cd-half-block').eq(0), directionFirstChild+translate1, boxShadowOpacity);
				translateBlock(actualBlock.find('.cd-half-block').eq(1), directionSecondChild+translate2, boxShadowOpacity);	
			}
